    ...
    <AuthLayout eyebrow="Get started" title="Create your store" subtitle="Set up the admin workspace. You can add products next.">
      <Stack component="form" spacing={2} onSubmit={submit}>
        ...
        <Grid container spacing={1.5}>
          ...
          <Grid item xs={12} sm={6}><TextField label="Password" name="password" type="password" autoComplete="new-password" inputProps={{ minLength: 8 }} value={form.password} onChange={change} required fullWidth /></Grid>
